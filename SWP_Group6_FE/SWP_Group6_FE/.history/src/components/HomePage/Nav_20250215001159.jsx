  ...
  return (
    ...
    <Card sx={{ maxWidth: 600 }}>
      ...
      <CardContent>
        ...
        <p>Working unit: Faculty of Psychology, University of Social Sciences and Humanities, VNU-HCM </p>
        </Typography>
      </CardContent>
      <CardActions>
    ...
    <Card sx={{ maxWidth: 600 }}>
      ...
      <CardContent>
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
        <span> Specialization: Psychology, Community Mental Health</span>
        <span> Teaching: School psychology consultancy</span>
        <span>Working unit: Faculty of Psychology, University of Social Sciences and Humanities, VNU-HCM </span>
        </Typography>
      </CardContent>
      <CardActions>
        <Button size="small">Detail</Button>
