        ...
        <Card key={index} sx={{ maxWidth: "100%", borderRadius: 5 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              ...
              <span className="text-sm text-black">Specialization:</span>{" "}
                {profile.specialization}
              </p>
              <p className="profile-text">
                <span className="text-sm text-black">Teaching:</span> {profile.teaching}
              </p>
              <p className="profile-text">
              <span className="text-sm text-black">Working unit:</span> {profile.unit}
              </p>
            </Typography>
          </CardContent>
          <CardActions>
