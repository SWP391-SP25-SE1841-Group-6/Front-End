      ...
      {profiles.map((profile, index) => (
        <Card key={index} sx={{ maxWidth: "100%" ,borderRadius:5}}>
          ...
          <CardContent>
            ...
            <p className="profile-text">Specialization: <span>{profile.specialization}</span></p>
<p className="profile-text">Teaching: <span>{profile.teaching}</span></p>
<p className="profile-text">Working unit: <span>{profile.unit}</span></p>
