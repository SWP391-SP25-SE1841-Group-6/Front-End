...
export default function Nav() {
  return (
    <div className="p-4 grid grid-cols-3 grid-rows-2 gap-2 border rounded-b-xl">
      {profiles.map((profile, index) => (
        <Card key={index} sx={{ maxWidth: 600 ,borderRadius:10}}>
          <CardMedia
            sx={{ height: 600, width: "90%", objectFit: "contain",paddingLeft:10 }}
            image={profile.image}
            title={profile.name}
          />
          <CardContent>
