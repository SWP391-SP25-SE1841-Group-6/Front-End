...
export default function Nav() {
  ...
  <span className="bold">Specialization:</span> {profile.specialization}
</p>
<p className="profile-text">
  <span className="bold">Teaching:</span> {profile.teaching}
</p>
<p className="profile-text">
  <span className="bold">Working unit:</span> {profile.unit}
</p>
