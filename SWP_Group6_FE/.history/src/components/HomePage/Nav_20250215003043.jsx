...
const profiles = [
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1658527049634-15142565537a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8JUUzJTgyJUEyJUUzJTgzJTkwJUUzJTgyJUJGJUUzJTgzJUJDfGVufDB8fDB8fHww",
  },
  {
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1690407617542-2f210cf20d7e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjV8fCVFMyU4MiVBMiVFMyU4MyU5MCVFMyU4MiVCRiVFMyU4MyVCQ3xlbnwwfHwwfHx8MA%3D%3D",
  },
  {
      ...
      {profiles.map((profile, index) => (
        <Card key={index} sx={{ maxWidth: "100%" ,borderRadius:5}}>
          ...
          <CardContent>
            ...
            <p><strong>Specialization:</strong> <span style={{ color: "inherit" }}>{profile.specialization}</span></p>
<p><strong>Teaching:</strong> <span style={{ color: "inherit" }}>{profile.teaching}</span></p>
<p><strong>Working unit:</strong> <span style={{ color: "inherit" }}>{profile.unit}</span></p>
