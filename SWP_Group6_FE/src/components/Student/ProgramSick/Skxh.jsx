    ...
    <>
      <div className="">
        ...
        <Link className="!text-4xl !text-black mt-6" to="/studenthome/Sknt">SỨC KHỎE NHẬN THỨC</Link>
          ...
          <h4  className="border-2 bg-blue-950 rounded-xl text-white max-w-60 max-h-30 text-center">SỨC KHỎE XÃ HỘI</h4>
      ...
      <div className="grid-cols-4 grid-rows-2 text-black mb-5 w-[95%] ">
        <div className="flex-row-2 flex-col-2 flex ml-20  ">
          ...
          Khả năng xây dựng và duy trì các mối quan hệ lành mạnh, hòa nhập với cộng đồng.
        ...
        <div className="flex-row-2 flex-col-2 flex ml-20  ">
          ...
          Kỹ năng giao tiếp và lắng nghe,khả năng thiết lập và duy trì quan hệ và kỹ năng giải quyết xung đột. 
            <p className="border-b-1 mt-2"></p>
          </span>
        </div>
