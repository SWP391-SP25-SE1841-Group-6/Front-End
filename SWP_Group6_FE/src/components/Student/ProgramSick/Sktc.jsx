    ...
    <>
      <div className="">
        ...
        <Link className="!text-4xl !text-black mt-6" to="/studenthome/Sknt">SỨC KHỎE NHẬN THỨC</Link>
          ...
          <h4 className="border-2 bg-blue-950 rounded-xl text-white max-w-60 max-h-30 text-center">SỨC KHỎE THỂ CHẤT </h4>
        </div>
      </div>
      ...
      <div className="grid-cols-4 grid-rows-2 text-black mb-5 w-[95%] ">
        <div className="flex-row-2 flex-col-2 flex ml-20  ">
          ...
          Tình trạng cơ thể khỏe mạnh, có sức đề kháng tốt và thể lực dẻo dai.
...
giấc ngủ và nghỉ ngơi đầy đủ.
        ...
        <div className="flex-row-2 flex-col-2 flex ml-30  ">
          ...
          Cơ thể tràn đầy năng lượng, ít mắc bệnh tật,
 cảm thấy khỏe mạnh, linh hoạt khi vận động,
 giữ được cân nặng hợp lý và vóc dáng cân đối.
            <p className="border-b-1 mt-2"></p>
          </span>
        </div>
      </div>
